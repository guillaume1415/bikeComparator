 ...
 */
final class Version20200427164148 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE test CHANGE marks_id marks_id INT DEFAULT NULL, CHANGE link link VARCHAR(255) DEFAULT NULL, CHANGE title title VARCHAR(255) DEFAULT NULL, CHANGE price price VARCHAR(255) DEFAULT NULL, CHANGE mark mark VARCHAR(255) DEFAULT NULL, CHANGE img img VARCHAR(255) DEFAULT NULL, CHANGE groupe groupe VARCHAR(255) DEFAULT NULL, CHANGE material material VARCHAR(255) DEFAULT NULL, CHANGE speed speed INT DEFAULT NULL, CHANGE poid poid INT DEFAULT NULL, CHANGE type type VARCHAR(255) DEFAULT NULL, CHANGE years years INT DEFAULT NULL, CHANGE poids_fabricant poids_fabricant INT DEFAULT NULL, CHANGE friens friens VARCHAR(255) DEFAULT NULL, CHANGE size1 size1 INT DEFAULT NULL, CHANGE size2 size2 INT DEFAULT NULL, CHANGE size3 size3 INT DEFAULT NULL, CHANGE size4 size4 INT DEFAULT NULL, CHANGE size5 size5 INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE mark (id INT AUTO_INCREMENT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
